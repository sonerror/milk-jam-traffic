...
public class CanvasOfferStarter : UICanvasPrime
{
    ...
    protected override void OnCloseCanvas()
    {
        ...
        BuyingPackDataFragment.cur.IsShowingStarter = false;
    }
    ...
    {
        AudioManager.ins.PlaySound(SoundType.UIClick);
        IAPPrime.ins.ClickPurchase(button.id, "OFFER STARTER", () => { Close(); });
    }
}