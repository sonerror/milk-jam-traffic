...
public class CanvasOfferRemoveAdsBundle : UICanvasPrime
{
    ...
    protected override void OnCloseCanvas()
    {
        ...
        BuyingPackDataFragment.cur.IsShowingRemoveAdsBundle = false;
    }
    ...
    {
        AudioManager.ins.PlaySound(SoundType.UIClick);
        IAPPrime.ins.ClickPurchase(button.id, "REMOVE ADS BUNDLE", () => { Close(); });
    }
}